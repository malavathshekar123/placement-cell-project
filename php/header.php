<img src="assets/img/scs-logo-1.png" height=70px" style="height:100px" />
<header id=" header" class="header fixed-top text-bg-primary p-3" data-scrollto-offset="0">
     <div class="container-fluid d-flex align-items-center justify-content-between">
         ...
         <p class="m-4"><b>DBMS PROJECT</b>: Amartya, Ajinkya, Kushalava, Shekar, Mohit</p>
