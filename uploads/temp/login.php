...
<body class="hold-transition skin-green sidebar-mini">
  <div class="wrapper">
    ...
    <header class="main-header flex mx-8 mt-4">
      ...
      <!-- <span class="logo-lg text-white bg-black"><b>Placement</b> Portal</span> -->
      </a>

      <a class="text-white bg-black"> Placement Portal</a>

      <!-- Header Navbar: style can be found in header.less -->
      <nav class="navbar navbar-static-top">
        <!-- Navbar Right Menu -->
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav mt-8">
            <li>
      ...
      <section class="content-header">
        <div class="container">
          <div class="row latest-job margin-top-50 margin-bottom-20">
            <h3 class="text-center margin-bottom-20">Log into your account</h3>
